 ...
 */
final class Version20231019104817 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE student (id INT AUTO_INCREMENT NOT NULL, n_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, age VARCHAR(255) NOT NULL, INDEX IDX_B723AF3363BD430E (n_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
